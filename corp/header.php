            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6  topbar-left">
                    <ul class="list-unstyled list-inline topbar-list">
                        <li><i class="fa fa-phone topbar-info-icon top-2"></i>tel: <span>020-12345678</span></li>
                        <li><i class="fa fa-envelope-o topbar-info-icon top-2"></i>
                            Email: <span>info@temp.com</span></li>
                    </ul>
                </div>
                <div class="col-md-6 col-sm-6  topbar-right">
                    <ul class="list-unstyled list-inline topbar-list pull-right ">
                        <li><a href="login.php">登录</a>
                        </li>
                        <li><a href="register.php">注册</a>
                        <li><a href="buy.php">购物车</a>
                        </li>
                    </ul>
                </div>
            </div>
    ...
    <div class="nav">
        <div class="container">
            <a class="header-logo" href="#">
                <img src="assets/image/logo-corp-red.png">
            </a>
            <!--BEGIN NAVIGATION-->
            <nav class="nav-box">
                <ul>
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" data-target="#" href="#">Woman
                        </a>
                    ...
                    <li class="dropdown dropdown-megamenu">
                        <a class="dropdown-toggle" data-toggle="dropdown" data-target="#" href="#">Man
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-sm-4 col-xs-6">
                                            <div class="product-item">
                                                <div class="pi-img-wrapper">
                                                    <a href="shop-item.html">
                                                        <img src="assets/frontend/pages/img/products/model7.jpg" class="img-responsive" alt="Berry Lace Dress"></a>
                                                </div>
                                                <h3><a href="shop-item.html">Berry Lace Dress</a></h3>
                                                <div class="pi-price">$29.00</div>
                                                <a href="#" class="btn btn-default add2cart">Add to cart</a>
